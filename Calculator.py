...
if __name__ == "__main__":
	...
	button9 = Button(gui, text=' 0 ', fg='black', bg='red', command=lambda: press(0), height=1, width=7)
	button9.grid(row=5, column=2)
	egal = Button(gui, text=' = ', fg='black', bg='red', command=equalpress, height=1, width=7)
	egal.grid(row=5, column=0)
	...
	inmultire = Button(gui, text=' * ', fg='black', bg='red', command=lambda: press("*"), height=1, width=7)
	inmultire.grid(row=4, column=3)
	impartire = Button(gui, text=' / ', fg='black', bg='red', command=lambda: press("/"), height=1, width=7)
	impartire.grid(row=5, column=3)
